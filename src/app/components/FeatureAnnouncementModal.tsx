...
export function FeatureAnnouncementModal({ 
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={(value) => {
      ...
      <DialogContent className="flex max-w-md flex-col gap-4 border border-zinc-800 bg-gradient-to-br from-zinc-900 to-zinc-950 p-6 text-zinc-50">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-zinc-400">
            Track your progress and earn special badges for your Barkle accomplishments! Look our for new achievements as you play.
          </DialogDescription>
        </DialogHeader>
